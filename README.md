...
ideas into innovation."<b></i></pre></div>
    ...
    <div class="bottomdiv">
        <p>Designed and Developed by Mahalakshmi.R (212223230117)</p>
    </div>
</body>
<html>
    ...
    <div class="header">
        ...
        <table class="person">
            <tr>
                ...
                <td>
                    <img src="aparna.jpg" class="sidsriram">
                </td>
                <td>
                    <img src="jyothika.jpg" class="gv">
                </td>
                <td>
                    <img src="pradeep.jpeg" class="dhanush">
                </td>
                <td>
                    <img src="sid.jpg" class="jonita">
                </td>
                <td>
                    <img src="surya.jpg" class="dhee">
                </td>
            </tr>
            <tr>
                <td>
...
## OUTPUT:
![alt text](<Screenshot 2024-04-16 210738.png>)
![alt text](<Screenshot 2024-04-16 210752.png>)
![alt text](<Screenshot 2024-04-16 210809.png>)
![alt text](<Screenshot 2024-04-16 210828.png>)
